const seoConfig = {
  ...
  'FractionalToDecimalConverter': {
    title: 'Fractional to Decimal Converter | Matched Betting Calculators',
    description:
  ...
  'convertDecimalToFraction': {
    title: 'Decimal to Fractional Converter | Matched Betting Calculators',
    description:
  ...
  'AdvancedOddsBoostCalculator': {
    title: 'Lay Stake Calculator - Boosted Odds | Matched Betting Calculators',
    description:
